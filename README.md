...
| file | Heap buffer overflow | Pointer/end guard | OSS-Fuzz 1064 parent/fix snapshots (2) | [Release](https://github.com/ysf/oss-brrrrr/releases/tag/file-oss-fuzz-1064-pointer-end-v1) |
...
| libplist | Heap buffer overflow | Pointer/end guard | OSS-Fuzz 55035 parent/fix snapshots (2) | [Release](https://github.com/ysf/oss-brrrrr/releases/tag/libplist-oss-fuzz-55035-pointer-end-v1) |
| OpenThread | Stack buffer overflow | Pointer/end guard | OSS-Fuzz 13619 parent/fix snapshots (2) | [Release](https://github.com/ysf/oss-brrrrr/releases/tag/openthread-oss-fuzz-13619-pointer-end-v1) |
| ClamAV | Heap buffer overflow | Remaining-length bounds checks | OSS-Fuzz 21960 parent/fix snapshots (2) | [Release](https://github.com/ysf/oss-brrrrr/releases/tag/clamav-oss-fuzz-21960-parent-fix) |
